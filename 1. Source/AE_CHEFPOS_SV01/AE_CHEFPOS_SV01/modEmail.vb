...
Module modEmail
    ...
    Public Sub EmailTemplate_Error()
        ...
        Try
            ...
            sBody = sBody & " Dear Valued Customer,<br /><br /> Eighteen chefs Interface program had encountered the problem based on the following information. <br /><br />"
    ...
    Public Sub EmailTemplate_Success()
        ...
        Try
            ...
            sBody = sBody & "<div align=left style='font-size:10.0pt;font-family:Arial'>"
            sBody = sBody & " Dear Valued Customer,<br /><br /> Eighteen Chefs Interface program had Successfully uploaded the files into SAP. <br /><br />"
